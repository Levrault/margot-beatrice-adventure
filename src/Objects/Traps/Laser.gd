...
func _ready() -> void:
	...
	tween.interpolate_property(beam, "width", MIN_BEAM_WIDTH, MAX_BEAM_WIDTH, BEAM_DURATION, Tween.EASE_IN, Tween.EASE_IN)
	tween.interpolate_property(beam, "width", MAX_BEAM_WIDTH, MIN_BEAM_WIDTH, BEAM_DURATION, Tween.EASE_OUT, Tween.EASE_IN, BEAM_DURATION)
	tween.start()
